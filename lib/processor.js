...
function preprocess(text, filename) {
  ...
  while ((match = regex.erbRegexChained.exec(text)) !== null) {
    ...
    const key = coordEndIndex.line - numAddLinesCounter;
    console.log(`startIndex line: ${coordStartIndex.line}, numAddLinesCounter: ${numAddLinesCounter}, key: ${key}`);
    const endIndexProcessed = endIndex + numDiffChars;

    offsetMap.addMapping(endIndexProcessed, key, numAddLinesCounter, numAddColumns);
  }
